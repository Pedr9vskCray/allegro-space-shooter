...
int main()
{
    ...
    while(1)
    {
        ...
        if(redraw && al_is_event_queue_empty(queue))
        {
            ...
            al_draw_text(font, al_map_rgb(255, 255, 255), 110, 90, 0, "Hello, my name is Mysha!");
            ...
            al_draw_filled_rounded_rectangle(100, 100, 420, 130, 2, 2, al_map_rgba(255, 107, 153, 3));
